...
import org.clas.modules.wc.calt0.T00Calib;
import org.clas.modules.wc.calt2d.SegmentProperty;
...
public class T0Calib extends AnalysisMonitor{
    ...
    public void processEvent(DataEvent event) {
        ...
        if(!event.hasBank("TimeBasedTrkg::TBHits")) { //commented out to test gemc hipo file- hamza
       ///if(!event.hasBank("ALRTDC::adc")) {
            return;
        }
        // get segment property

        DataBank bnkHits = event.getBank("TimeBasedTrkg::TBHits");  //commented out to test gemc hipo file- hamza
      //  DataBank bnkHits = event.getBank("ALRTDC::adc");
