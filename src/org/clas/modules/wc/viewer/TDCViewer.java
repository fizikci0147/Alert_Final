...
import org.clas.modules.wc.analysis.configButtonPanel;
import org.clas.modules.wc.caltdccuts.TDCCuts;
//import org.jlab.detector.base.DetectorType;
//import org.jlab.detector.base.GeometryFactory;
//import org.clas.modules.wc.analysis.WcGeometryFactory;
...
//import org.clas.modules.wc.Constants;
  ...
  //  public static JTextField nWires = new JTextField(3);
   // public static JTextField deltaWire = new JTextField(3);
    ...
    public TDCViewer() throws FileNotFoundException {
        this.monitors = new AnalysisMonitor[]{new TDCCuts("ALERT calibration",ccdb)};
        // create main panel
...
//        System.out.println("Time to update ...");
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        JFrame frame = new JFrame("WC calibration");
